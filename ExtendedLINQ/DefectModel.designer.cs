...
namespace ExtendedLINQ
{
    ...
    partial void DeleteNotificationSubscription(NotificationSubscription instance);
		...
		public DefectModelDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["SkeetysoftDefectsConnectionString"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
	...
	public partial class Defect : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<User> _DefectUser;
    ...
    partial void OnProjectIDChanged();
		...
		public Defect()
		{
			...
			this._DefectUser = default(EntityRef<User>);
		...
		public User DefectUser
		{
			...
			set
			{
				User previousValue = this._DefectUser.Entity;
				if (((previousValue != value) 
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="DefectUser_Defect1", Storage="_User", ThisKey="CreatedByUserID", OtherKey="UserID", IsForeignKey=true)]
		public User User
		{
			get
			{
    ...
    partial void OnNameChanging(string value);
    partial void OnNameChanged();
    partial void OnUserTypeChanging(Status value);
